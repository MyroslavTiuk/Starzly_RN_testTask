...
var VisibilitySensor = function (props) {
    var myView = React.useRef(null);
    var _a = React.useState(false), lastValue = _a[0], setLastValue = _a[1];
    ...
    var startWatching = function () {
        ...
        interval = setInterval(function () {
            ...
            myView.current.measure(function (_x, _y, width, height, pageX, pageY) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var isInViewPort = function () {
        ...
        var isVisible = dimensions.rectBottom != 0 &&
    ...
    return (React__default.createElement(reactNative.View, __assign({ collapsable: false, ref: myView }, props),
        props.children,
